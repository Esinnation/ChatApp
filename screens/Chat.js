...
import {addDoc,doc, serverTimestamp,orderBy,onSnapshot,collection,getDocs,query,} from "firebase/firestore";
    ...
    navigation.setOptions({
      ...
      headerRight:()=>(
        <View style={{
          ...
          <TouchableOpacity>
            <FontAwesome name='video-camera' size={24} color='white' style={{marginRight:10}} />
          </TouchableOpacity>
          <TouchableOpacity>
      ...
      >
        ...
        <>
          ...
          <View style={styles.footer}>
            <TextInput onSubmitEditing={sendMessage} value={input} onChangeText={text=>setInput(text)} placeholder='Message' style={styles.textInput} />
